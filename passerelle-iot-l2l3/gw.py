...
def on_message(unused_client, unused_userdata, message):
  ...
  if ser:
    print("Sending command to the wearable...")
    command = message.payload.decode()
    if "ASTHME" in command:
      serial_write(ser, "ASTHME")
    elif "HYPERTENSION" in command:
      serial_write(ser, "HYPERTENSION")
    elif "AVC" in command:
      serial_write(ser, "AVC")
    else:
      serial_write(ser, "NO RISK")
